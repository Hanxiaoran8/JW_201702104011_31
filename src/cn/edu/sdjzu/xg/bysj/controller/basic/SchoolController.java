 ...
 */
@WebServlet("/basic/school.ctl")
public class SchoolController extends HttpServlet {

    /**
     * POST, http://49.234.112.12:8080/bysj1860/school.ctl, 增加学院
...
//        schoolToAdd.setId(4 + (int)(Math.random()*100));
    ...
    /**
     * DELETE, http://49.234.112.12:8080/bysj1860/school.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT, http://49.234.112.12:8080/bysj1860/school.ctl, 修改学院
     *
    ...
    /**
     * GET, http://49.234.112.12:8080/bysj1860/school.ctl?id=1, 查询id=1的学院
     * GET, http://49.234.112.12:8080/bysj1860/school.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
